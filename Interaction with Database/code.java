//Write a Java program that interacts with database
import java.sql.*;
import javax.swing.*;
...
try
{
ps3=con.prepareStatement("update emp set 
name='"+tf2.getText()+"' where id='"+Integer.parseInt(tf1.getText())+"'");
ps3.executeUpdate();
}
catch(Exception e)
{
...
try
{
ps4=con.prepareStatement("delete from emp where 
...
try
{
a.con=DriverManager.getConnection("jdbc:mysql://localhos
t:3306/cse1?autoReconnect=true&useSSL=false","root","HardikSingh");
